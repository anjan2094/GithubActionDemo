...
def upload_to_blackblaze(file_link, file_name):
    try:
        ...
        id_and_key = '002333ef583cfac0000000002:K002Q7RLfuQY3kOcvc12uxRkTsB++1M'
        ...
        bucket_id = 'e3c393aecf4578836c7f0a1c'
...
def ApkLink(VERSION_NAME, campaign):
    try:
        return "https://cdn-app.spcafe.in/file/nostra/NostragamusPro-" + VERSION_NAME + "-" + campaign + ".apk"
    except:
...
def main():
    ...
    allCampaignDict = fetchAllEligibleCampaigns(1577)

    for campaign in allCampaignDict[:3]:
        campaignName = campaign["template_id"]
